                            ...
                            <CardContent>
                                <div className="space-y-6">
                                    {filteredData.map(item => {
                                        ...
                                        const progressColor = item.utilizationRate > 80 ? 'bg-green-500' : 
                                                             item.utilizationRate < 50 ? 'bg-amber-500' : 'bg-blue-500';
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center gap-3">
                                        <div className={`h-10 w-10 rounded-lg flex items-center justify-center ${
                                            budgetMetrics.totalVariancePercent > 0 ? 'bg-red-600/10 text-red-600' : 'bg-green-600/10 text-green-600'
                                        }`}>
