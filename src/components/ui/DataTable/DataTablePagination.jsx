...
export function DataTablePagination({ table }) {
    ...
    return (
        <div className={cn("flex items-center justify-between px-2", isDense ? "py-1" : "py-2")}>
            ...
            <div className="flex items-center space-x-6 lg:space-x-8">
                <div className="flex items-center space-x-2">
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Rows per page</p>
                    <Select
                    ...
                    >
                        <SelectTrigger className="h-8 w-[70px] bg-muted/50 border-none shadow-none text-xs font-bold">
