...
const navItems = [
    ...
    },
    {
        title: 'Configuration',
        items: [
            { path: '/library/members', label: 'Team Members', icon: Users, adminOnly: true },
            { path: '/library/phases', label: 'Phases', icon: Layers, adminOnly: true },
            { path: '/library/tasks', label: 'Task Templates', icon: ListTodo, adminOnly: true },
            { path: '/library/complexity', label: 'Complexity', icon: SlidersHorizontal, adminOnly: true },
            { path: '/library/costs', label: 'Resource Costs', icon: Coins, adminOnly: true },
