...
export default function TeamMembers() {
    const { state, dispatch, addMember, updateMember, deleteMember } = useApp();
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return costTier ? (
                    ...
                    <Link to="/library/costs" className="text-xs text-slate-400 hover:text-indigo-600 flex items-center gap-1 group">
                        Not linked
